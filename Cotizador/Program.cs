...
namespace Cotizador
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Euro a Dolar: {euro1.GetCantidad()} Euros = {dolarDesdeEuro.GetCantidad():f2} Dólares");
            Console.WriteLine($"Peso a Dolar: {peso1.GetCantidad()} Pesos = {dolarDesdePeso.GetCantidad():f2} Dólares");
            ...
            // Mostrar resultados
            Console.WriteLine($"Suma en Dólar: {dolar1.GetCantidad()} + {euro1.GetCantidad()} Euros = {sumaDolar.GetCantidad():f2} Dólares");
            Console.WriteLine($"Resta en Dólar: {dolar1.GetCantidad()} - {peso1.GetCantidad()} Pesos = {restaDolar.GetCantidad():f2} Dólares");
